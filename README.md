...
public class Login extends JDialog {
  ...
  public Login() {
    ...
    JButton loginbtn = new JButton("Cancel");
    btnLogin.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        if(username.getText().equals("KRYPROMANIAC") && password.getText().equals("12345") ) {
          JOptionPane.showMessageDialog(null, "Login Sucessful ");
          //YOUR CODE GOES HERE
        }else
        {
          JOptionPane.showMessageDialog(null, "Invalid ", "Please Check", JOptionPane.WARNING_MESSAGE);
          return;
        }
      }
    });
